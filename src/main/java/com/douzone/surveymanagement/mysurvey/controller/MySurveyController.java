...
public class MySurveyController {
    ...
    public ResponseEntity<CommonResponse<List<MySurveyDTO>>> selectMySurvey(
        ...
        List<MySurveyDTO> myWriteSurveys = mySurveyServiceImpl.selectMySurveysWithSorting(
    ...
    public ResponseEntity<CommonResponse<List<MySurveyDTO>>> selectAttendSurvey(
        ...
        List<MySurveyDTO> myAttendSurveys = mySurveyServiceImpl.selectMyParticipatedSurveys(
            userDetails.getUserNo());
